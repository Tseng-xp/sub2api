...
const showIcpBeian = computed(() => {
  if (typeof window === 'undefined' || typeof window.location?.hostname !== 'string') return false
  return window.location.hostname.toLowerCase().endsWith('.cn')
})
