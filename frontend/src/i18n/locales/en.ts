  ...
  admin: {
    ...
    settings: {
      ...
      defaults: {
        ...
        defaultDisplayCurrencyHint: 'Default currency display for UI, empty means USD',
        defaultExchangeRate: 'Default Exchange Rate',
        defaultExchangeRateHint: 'How much CNY per 1 USD, 0 means not configured (always show USD)',
        currencyAuto: 'Auto (USD)',
