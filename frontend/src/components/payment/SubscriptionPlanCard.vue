      ...
      <div class="mb-3 flex items-start justify-between gap-2">
        ...
        <div class="shrink-0 text-right">
          ...
          <div v-if="plan.original_price" class="mt-0.5 flex items-center justify-end gap-1.5">
            <span v-if="plan.currency" class="text-xs text-gray-400 line-through dark:text-dark-500">${{ plan.original_price }} {{ plan.currency }}</span>
            <span v-else class="text-xs text-gray-400 line-through dark:text-dark-500">{{ usd(plan.original_price) }}</span>
