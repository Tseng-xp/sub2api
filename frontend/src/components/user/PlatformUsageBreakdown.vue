<template>
  <div class="group/usage relative text-sm">
    <div class="flex items-center gap-1.5">
      ...
      <span class="font-medium text-gray-900 dark:text-white">{{ currencyStore.formatAmount(today) }}</span>
      <Icon
        v-if="hasBreakdown"
        name="infoCircle"
        size="xs"
    ...
    <div class="mt-0.5 flex items-center gap-1.5">
      ...
      <span class="font-medium text-gray-900 dark:text-white">{{ currencyStore.formatAmount(total) }}</span>
    </div>
    ...
    >
      ...
      >
        ...
        <span class="font-mono">
          {{ currencyStore.formatAmount(item.today_actual_cost) }}
