<template>
  ...
  >
        ...
        <div class="sidebar-section">
          <template v-for="item in adminNavItems" :key="item.path">
            ...
            <template v-if="item.children?.length">
              ...
              <!-- Children -->
              <div v-if="!sidebarCollapsed && isGroupExpanded(item)" class="mb-1 ml-4 border-l border-primary-500/15 pl-2 dark:border-primary-500/20">
                <router-link
    ...
    <!-- Bottom Section -->
    <div class="mt-auto border-t border-gray-100 p-3 dark:border-primary-500/10">
      <!-- Theme Toggle -->
      <button
        @click="toggleTheme"
